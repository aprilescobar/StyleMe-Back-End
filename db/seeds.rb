...
User.create(
    ...
    username:'zoesug', 
    password:'zoe', 
    img_url:'https://pbs.twimg.com/profile_images/958656137099927554/EQwfYr4V.jpg'
)
...
User.create(
    ...
    username:'tess', 
    password:'tess', 
    img_url:'https://pbs.twimg.com/profile_images/1088302683742785536/IwTPyXJw_400x400.jpg'
)
...
User.create(
    ...
    username:'patb', 
    password:'pat', 
    img_url:'https://hips.hearstapps.com/hmg-prod.s3.amazonaws.com/images/patricia-bright-gives-birth-1577207156.jpg'
)
...
User.create(
    ...
    username:'cool', 
    password:'cool', 
    img_url:'https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcTOFK-fSWTgWzv5EsSVgVtPFng7RV4DSX1cdg&usqp=CAU'
)
...
User.create(
    ...
    username:'mel', 
    password:'mel', 
    img_url:'https://influencermatchmaker.co.uk/sites/default/files/2019-12/meljoy2.JPG'
)
...
User.create(
    ...
    username:'kal', 
    password:'kal', 
    img_url:'https://celebslifereel.com/wp-content/uploads/2019/01/Kalyn-Nicholson.jpg'
)
...
User.create(
    ...
    username:'amber', 
    password:'amber', 
    img_url:'data:image/jpeg;base64,'
)
...
User.create(
    ...
    username:'loey', 
    password:'loey', 
    img_url:'https://www.famousbirthdays.com/faces/lane-loey-image.jpg'
)
...
User.create(
    ...
    username:'kol', 
    password:'kol', 
    img_url:'https://bookingagentinfo.com/wp-content/uploads/2018/02/Koleen-Diaz-Contact-Information.jpg'
)
...
User.create(
    ...
    username:'chris', 
    password:'chris', 
    img_url:'https://cdn.vox-cdn.com/thumbor/CkkW2kYsnQ2D9dGu8SbNs7dBWM4=/0x7:1000x757/1400x1400/filters:focal(0x7:1000x757):format(jpeg)/cdn.vox-cdn.com/uploads/chorus_image/image/49737085/chriselle-lim-in-the-bag-3.0.0.jpg'
)
...
User.create(
    ...
    username:'summer', 
    password:'summer', 
    img_url:'https://bookingagentinfo.com/wp-content/uploads/2018/09/Summer-Mckeen-Contact-Information.jpg'
)
...
User.create(
    ...
    username:'sam', 
    password:'sam', 
    img_url:'https://pbs.twimg.com/profile_images/1256694521125093379/UAx9fNVh_400x400.jpg'
)
...
Top.create(
    ...
    seasons: 'spring summer fall winter', 
    sleeve_length: 'short',
    live_view:'https://lp2.hm.com/hmgoepprod?set=quality[79],source[/85/1f/851ff5d609f7ff8dcda39f3de6870ad549f27731.jpg],origin[dam],category[ladies_tops_shortsleeve],type[LOOKBOOK],res[m],hmver[1]&call=url[file:/product/main]',
    img_url:'https://lp2.hm.com/hmgoepprod?set=quality[79],source[/e8/a6/e8a68359c7c5f748ebb5c64a2a1b6510192dbd80.jpg],origin[dam],category[ladies_tops_shortsleeve],type[DESCRIPTIVESTILLLIFE],res[m],hmver[1]&call=url[file:/product/main]',
    back_view:'https://lp2.hm.com/hmgoepprod?set=quality[79],source[/f3/d7/f3d782f2991f9ca6547ceeba6a05791e730e63eb.jpg],origin[dam],category[ladies_tops_shortsleeve],type[LOOKBOOK],res[y],hmver[1]&call=url[file:/product/main]',
)
...
Top.create(
    ...
    seasons: 'spring summer fall winter', 
    sleeve_length: 'short',
    live_view:'https://lp2.hm.com/hmgoepprod?set=quality[79],source[/8e/24/8e2442d40b642029201010006e47c28391d27145.jpg],origin[dam],category[ladies_tops_shortsleeve],type[LOOKBOOK],res[y],hmver[1]&call=url[file:/product/main]',
    img_url:'https://lp2.hm.com/hmgoepprod?set=quality[79],source[/e8/b0/e8b0bc9b9d1272d5186d952565d53d8f83832a36.jpg],origin[dam],category[ladies_tops_shortsleeve],type[DESCRIPTIVESTILLLIFE],res[y],hmver[1]&call=url[file:/product/main]',
    back_view:'https://lp2.hm.com/hmgoepprod?set=quality[79],source[/2a/0d/2a0d8d813da7e7459fb0bd1748adb773983d3a19.jpg],origin[dam],category[ladies_tops_shortsleeve],type[LOOKBOOK],res[y],hmver[1]&call=url[file:/product/main]',
)
...
Top.create(
    ...
    sleeve_length: 'short',
    live_view:'https://lp2.hm.com/hmgoepprod?set=quality[79],source[/bb/74/bb74be12439d2fe122c94dfc4d4cd7e6347bbdc3.jpg],origin[dam],category[ladies_tops_shortsleeve],type[LOOKBOOK],res[y],hmver[1]&call=url[file:/product/main]',
    img_url:'https://lp2.hm.com/hmgoepprod?set=quality[79],source[/57/ea/57ea6b97bc8c0afb5ad7425c03a7b54c9f0dde86.jpg],origin[dam],category[ladies_tops_shortsleeve],type[DESCRIPTIVESTILLLIFE],res[y],hmver[1]&call=url[file:/product/main]',
    back_view:'https://lp2.hm.com/hmgoepprod?set=quality[79],source[/77/39/77398b140de29760810901ca1fea43086337affc.jpg],origin[dam],category[ladies_tops_shortsleeve],type[LOOKBOOK],res[y],hmver[1]&call=url[file:/product/main]',
)
...
Top.create(
    ...
    seasons: 'spring summer fall winter', 
    sleeve_length: 'short',
    live_view:'https://lp2.hm.com/hmgoepprod?set=quality[79],source[/d8/ad/d8ad69ffe3539868dc50e382c0c1cd319f50b712.jpg],origin[dam],category[ladies_tops_shortsleeve],type[LOOKBOOK],res[y],hmver[1]&call=url[file:/product/main]',
    img_url:'https://lp2.hm.com/hmgoepprod?set=quality[79],source[/71/ae/71aeb52627dc6f640256213cdbf51030c70c32c9.jpg],origin[dam],category[ladies_tops_shortsleeve],type[DESCRIPTIVESTILLLIFE],res[y],hmver[1]&call=url[file:/product/main]',
    back_view:'https://lp2.hm.com/hmgoepprod?set=quality[79],source[/25/f7/25f756e4d0c0891aca76ac61aa57a78e99c44c82.jpg],origin[dam],category[ladies_tops_shortsleeve],type[LOOKBOOK],res[y],hmver[1]&call=url[file:/product/main]',
)
...
Top.create(
    ...
    live_view:'https://lp2.hm.com/hmgoepprod?set=quality[79],source[
type[LOOKBOOK],res[m],hmver[1]&call=url[file:/product/main]',
    img_url:'https://lp2.hm.com/hmgoepprod?set=quality[79],source[/29/37/2937b314b408815545dc676f6b63cd09a71ba6d7.jpg],origin[dam],category[ladies_jeans_straight],type[DESCRIPTIVESTILLLIFE],res[y],hmver[1]&call=url[file:/product/main]',
    back_view:'https://lp2.hm.com/hmgoepprod?set=quality[79],source[/e3/48/e348c575eaed1215d7674f1f92e5a279388c178c.jpg],origin[dam],category[ladies_jeans_straight],type[LOOKBOOK],res[y],hmver[1]&call=url[file:/product/main]',
)
...
Bottom.create(
    ...
    seasons: 'spring summer fall winter', 
    length: 'ankle',
    live_view:'https://lp2.hm.com/hmgoepprod?set=quality[79],source[/1b/54/1b542cd0d8246374b189feb175a2bd461b709d34.jpg],origin[dam],category[ladies_jeans_straight],type[LOOKBOOK],res[m],hmver[1]&call=url[file:/product/main]',
    img_url:'https://lp2.hm.com/hmgoepprod?set=quality[79],source[/c8/1f/c81f0dd420518716e194c92095a21b9ef58d6536.jpg],origin[dam],category[ladies_jeans_straight],type[DESCRIPTIVESTILLLIFE],res[y],hmver[1]&call=url[file:/product/main]',
    back_view:'https://lp2.hm.com/hmgoepprod?set=quality[79],source[/eb/89/eb89cd78c1af6fb20577fbd3ee5aa6ce7d8a8d2e.jpg],origin[dam],category[ladies_jeans_straight],type[LOOKBOOK],res[y],hmver[1]&call=url[file:/product/main]',
)
...
FavoriteTop.create(user_id:1, top_id:37)
FavoriteTop.create(user_id:1, top_id:57)

FavoriteTop.create(user_id:2, top_id:8)
FavoriteTop.create(user_id:2, top_id:46)
FavoriteTop.create(user_id:2, top_id:64)

FavoriteTop.create(user_id:3, top_id:15)
FavoriteTop.create(user_id:3, top_id:64)
FavoriteTop.create(user_id:3, top_id:66)

FavoriteTop.create(user_id:4, top_id:64)
FavoriteTop.create(user_id:4, top_id:66)
FavoriteTop.create(user_id:4, top_id:15)

FavoriteTop.create(user_id:5, top_id:65)
FavoriteTop.create(user_id:5, top_id:60)

FavoriteTop.create(user_id:6, top_id:8)

FavoriteTop.create(user_id:7, top_id:57)
FavoriteTop.create(user_id:7, top_id:62)
FavoriteTop.create(user_id:7, top_id:66)

FavoriteTop.create(user_id:8, top_id:38)
FavoriteTop.create(user_id:8, top_id:70)
FavoriteTop.create(user_id:8, top_id:24)
FavoriteTop.create(user_id:8, top_id:8)

FavoriteTop.create(user_id:9, top_id:57)
FavoriteTop.create(user_id:9, top_id:70)
FavoriteTop.create(user_id:9, top_id:46)

FavoriteTop.create(user_id:10, top_id:67)
FavoriteTop.create(user_id:10, top_id:21)

FavoriteTop.create(user_id:11, top_id:59)
FavoriteTop.create(user_id:11, top_id:57)

FavoriteTop.create(user_id:12, top_id:66)

FavoriteTop.create(user_id:13, top_id:40)
FavoriteTop.create(user_id:13, top_id:37)

FavoriteTop.create(user_id:14, top_id:53)
FavoriteTop.create(user_id:14, top_id:8)
FavoriteTop.create(user_id:14, top_id:67)
FavoriteTop.create(user_id:14, top_id:31)

FavoriteTop.create(user_id:15, top_id:13)
FavoriteTop.create(user_id:15, top_id:15)

# FavoriteTop.create(user_id:, top_id:)
p "favoriteTops seeded"

FavoriteBottom.create(user_id:1, bottom_id:4)
FavoriteBottom.create(user_id:1, bottom_id:52)
FavoriteBottom.create(user_id:1, bottom_id:53)
FavoriteBottom.create(user_id:1, bottom_id:8)

FavoriteBottom.create(user_id:2, bottom_id:62)
FavoriteBottom.create(user_id:2, bottom_id:18)
FavoriteBottom.create(user_id:2, bottom_id:53)

FavoriteBottom.create(user_id:3, bottom_id:31)
FavoriteBottom.create(user_id:3, bottom_id:29)
FavoriteBottom.create(user_id:3, bottom_id:62)

FavoriteBottom.create(user_id:4, bottom_id:69)
FavoriteBottom.create(user_id:4, bottom_id:31)
FavoriteBottom.create(user_id:4, bottom_id:29)

FavoriteBottom.create(user_id:5, bottom_id:4)
FavoriteBottom.create(user_id:5, bottom_id:8)
FavoriteBottom.create(user_id:5, bottom_id:69)

FavoriteBottom.create(user_id:6, bottom_id:21)

FavoriteBottom.create(user_id:7, bottom_id:57)
FavoriteBottom.create(user_id:7, bottom_id:62)
FavoriteBottom.create(user_id:7, bottom_id:15)
...
FavoriteBottom.create(user_id:9, bottom_id:66)

FavoriteBottom.create(user_id:10, bottom_id:62)
FavoriteBottom.create(user_id:10, bottom_id:69)

FavoriteBottom.create(user_id:11, bottom_id:62)
FavoriteBottom.create(user_id:11, bottom_id:4)

FavoriteBottom.create(user_id:12, bottom_id:30)

FavoriteBottom.create(user_id:13, bottom_id:65)

FavoriteBottom.create(user_id:14, bottom_id:70)
FavoriteBottom.create(user_id:14, bottom_id:11)
FavoriteBottom.create(user_id:14, bottom_id:21)
FavoriteBottom.create(user_id:14, bottom_id:70)

FavoriteBottom.create(user_id:15, bottom_id:31)
FavoriteBottom.create(user_id:15, bottom_id:68)

# FavoriteBottom.create(user_id:, bottom_id:)
p "favoriteBottoms seeded"

FavoriteShoe.create(user_id:1, shoe_id:28)
FavoriteShoe.create(user_id:1, shoe_id:5)
FavoriteShoe.create(user_id:1, shoe_id:9)
FavoriteShoe.create(user_id:1, shoe_id:22)

FavoriteShoe.create(user_id:2, shoe_id:29)
FavoriteShoe.create(user_id:2, shoe_id:5)
FavoriteShoe.create(user_id:2, shoe_id:13)

FavoriteShoe.create(user_id:3, shoe_id:33)
FavoriteShoe.create(user_id:3, shoe_id:31)

FavoriteShoe.create(user_id:4, shoe_id:7)
FavoriteShoe.create(user_id:4, shoe_id:29)

FavoriteShoe.create(user_id:5, shoe_id:47)

FavoriteShoe.create(user_id:6, shoe_id:66)

FavoriteShoe.create(user_id:7, shoe_id:9)
FavoriteShoe.create(user_id:7, shoe_id:10)
FavoriteShoe.create(user_id:7, shoe_id:31)

FavoriteShoe.create(user_id:8, shoe_id:58)
FavoriteShoe.create(user_id:8, shoe_id:13)
FavoriteShoe.create(user_id:8, shoe_id:26)
FavoriteShoe.create(user_id:8, shoe_id:5)

FavoriteShoe.create(user_id:9, shoe_id:20)
FavoriteShoe.create(user_id:9, shoe_id:9)
FavoriteShoe.create(user_id:9, shoe_id:5)

FavoriteShoe.create(user_id:10, shoe_id:25)
FavoriteShoe.create(user_id:10, shoe_id:20)

FavoriteShoe.create(user_id:11, shoe_id:55)
FavoriteShoe.create(user_id:11, shoe_id:26)

FavoriteShoe.create(user_id:12, shoe_id:55)

FavoriteShoe.create(user_id:13, shoe_id:7)
FavoriteShoe.create(user_id:13, shoe_id:8)

FavoriteShoe.create(user_id:14, shoe_id:25)
FavoriteShoe.create(user_id:14, shoe_id:66)
FavoriteShoe.create(user_id:14, shoe_id:29)
FavoriteShoe.create(user_id:14, shoe_id:25)

FavoriteShoe.create(user_id:15, shoe_id:29)
FavoriteShoe.create(user_id:15, shoe_id:31)
...
Like.create(user_id:4, outfit_id:1)
Like.create(user_id:5, outfit_id:1)
Like.create(user_id:6, outfit_id:1)
Like.create(user_id:7, outfit_id:1)
Like.create(user_id:8, outfit_id:1)
Like.create(user_id:9, outfit_id:1)
Like.create(user_id:10, outfit_id:1)
Like.create(user_id:11, outfit_id:1)
Like.create(user_id:12, outfit_id:1)
Like.create(user_id:13, outfit_id:1)

Like.create(user_id:15, outfit_id:2)
Like.create(user_id:14, outfit_id:2)
Like.create(user_id:13, outfit_id:2)
Like.create(user_id:12, outfit_id:2)
Like.create(user_id:11, outfit_id:2)
Like.create(user_id:10, outfit_id:2)
Like.create(user_id:9, outfit_id:2)
Like.create(user_id:8, outfit_id:2)
Like.create(user_id:7, outfit_id:2)
Like.create(user_id:6, outfit_id:2)
Like.create(user_id:5, outfit_id:2)
Like.create(user_id:4, outfit_id:2)
Like.create(user_id:3, outfit_id:2)
Like.create(user_id:2, outfit_id:2)

Like.create(user_id:1, outfit_id:3)
Like.create(user_id:3, outfit_id:3)
Like.create(user_id:4, outfit_id:3)
Like.create(user_id:5, outfit_id:3)
Like.create(user_id:6, outfit_id:3)
Like.create(user_id:7, outfit_id:3)
Like.create(user_id:8, outfit_id:3)
Like.create(user_id:9, outfit_id:3)
Like.create(user_id:10, outfit_id:3)

Like.create(user_id:11, outfit_id:4)
Like.create(user_id:12, outfit_id:4)
Like.create(user_id:13, outfit_id:4)
Like.create(user_id:14, outfit_id:4)
Like.create(user_id:15, outfit_id:4)
Like.create(user_id:10, outfit_id:4)

Like.create(user_id:9, outfit_id:5)
Like.create(user_id:8, outfit_id:5)
Like.create(user_id:7, outfit_id:5)
Like.create(user_id:6, outfit_id:5)
Like.create(user_id:5, outfit_id:5)
Like.create(user_id:4, outfit_id:5)
Like.create(user_id:2, outfit_id:5)
Like.create(user_id:1, outfit_id:5)
Like.create(user_id:10, outfit_id:5)
Like.create(user_id:11, outfit_id:5)

Like.create(user_id:12, outfit_id:6)
Like.create(user_id:13, outfit_id:6)
Like.create(user_id:14, outfit_id:6)
Like.create(user_id:15, outfit_id:6)
Like.create(user_id:11, outfit_id:6)
Like.create(user_id:10, outfit_id:6)

Like.create(user_id:9, outfit_id:7)
Like.create(user_id:8, outfit_id:7)
Like.create(user_id:7, outfit_id:7)
Like.create(user_id:6, outfit_id:7)
Like.create(user_id:4, outfit_id:7)
Like.create(user_id:3, outfit_id:7)

Like.create(user_id:2, outfit_id:8)
Like.create(user_id:1, outfit_id:8)
Like.create(user_id:3, outfit_id:8)
Like.create(user_id:4, outfit_id:8)
Like.create(user_id:5, outfit_id:8)
Like.create(user_id:6, outfit_id:8)
Like.create(user_id:7, outfit_id:8)
Like.create(user_id:9, outfit_id:8)
Like.create(user_id:10, outfit_id:8)

Like.create(user_id:11, outfit_id:9)
Like.create(user_id:12, outfit_id:9)
Like.create(user_id:13, outfit_id:9)
Like.create(user_id:14, outfit_id:9)
Like.create(user_id:15, outfit_id:9)
Like.create(user_id:10, outfit_id:9)
Like.create(user_id:8, outfit_id:9)
Like.create(user_id:7, outfit_id:9)

Like.create(user_id:5, outfit_id:10)
Like.create(user_id:4, outfit_id:10)
Like.create(user_id:3, outfit_id:10)
Like.create(user_id:2, outfit_id:10)
Like.create(user_id:1, outfit_id:10)
Like.create(user_id:7, outfit_id:10)
Like.create(user_id:8, outfit_id:10)
Like.create(user_id:9, outfit_id:10)

Like.create(user_id:10, outfit_id:11)
Like.create(user_id:11, outfit_id:11)
Like.create(user_id:12, outfit_id:11)
Like.create(user_id:13, outfit_id:11)
Like.create(user_id:14, outfit_id:11)
Like.create(user_id:15, outfit_id:11)
Like.create(user_id:9, outfit_id:11)
Like.create(user_id:8, outfit_id:11)

Like.create(user_id:7, outfit_id:12)
Like.create(user_id:6, outfit_id:12)
Like.create(user_id:4, outfit_id:12)
Like.create(user_id:3, outfit_id:12)
Like.create(user_id:2, outfit_id:12)
Like.create(user_id:1, outfit_id:12)
Like.create(user_id:8, outfit_id:12)
Like.create(user_id:9, outfit_id:12)
Like.create(user_id:10, outfit_id:12)
Like.create(user_id:11, outfit_id:12)

Like.create(user_id:12, outfit_id:13)
Like.create(user_id:13, outfit_id:13)
Like.create(user_id:14, outfit_id:13)
Like.create(user_id:15, outfit_id:13)
Like.create(user_id:11, outfit_id:13)
Like.create(user_id:10, outfit_id:13)
Like.create(user_id:8, outfit_id:13)

Like.create(user_id:7, outfit_id:14)
Like.create(user_id:6, outfit_id:14)
Like.create(user_id:5, outfit_id:14)
Like.create(user_id:4, outfit_id:14)
Like.create(user_id:2, outfit_id:14)
Like.create(user_id:1, outfit_id:14)
Like.create(user_id:8, outfit_id:14)
Like.create(user_id:9, outfit_id:14)
Like.create(user_id:10, outfit_id:14)

Like.create(user_id:11, outfit_id:15)
Like.create(user_id:12, outfit_id:15)
Like.create(user_id:13, outfit_id:15)
Like.create(user_id:14, outfit_id:15)
Like.create(user_id:15, outfit_id:15)

Like.create(user_id:1, outfit_id:16)
Like.create(user_id:2, outfit_id:16)
Like.create(user_id:3, outfit_id:16)
Like.create(user_id:4, outfit_id:16)
Like.create(user_id:5, outfit_id:16)
Like.create(user_id:6, outfit_id:16)
Like.create(user_id:7, outfit_id:16)
Like.create(user_id:8, outfit_id:16)
Like.create(user_id:9, outfit_id:16)
Like.create(user_id:11, outfit_id:16)
Like.create(user_id:12, outfit_id:16)
Like.create(user_id:13, outfit_id:16)

Like.create(user_id:14, outfit_id:17)
Like.create(user_id:15, outfit_id:17)
Like.create(user_id:13, outfit_id:17)
Like.create(user_id:12, outfit_id:17)
Like.create(user_id:11, outfit_id:17)
Like.create(user_id:10, outfit_id:17)
Like.create(user_id:9, outfit_id:17)
Like.create(user_id:8, outfit_id:17)
Like.create(user_id:6, outfit_id:17)

Like.create(user_id:5, outfit_id:18)
Like.create(user_id:4, outfit_id:18)
Like.create(user_id:3, outfit_id:18)
Like.create(user_id:2, outfit_id:18)
Like.create(user_id:6, outfit_id:18)
Like.create(user_id:7, outfit_id:18)
Like.create(user_id:8, outfit_id:18)

Like.create(user_id:9, outfit_id:19)
Like.create(user_id:10, outfit_id:19)
Like.create(user_id:12, outfit_id:19)
Like.create(user_id:13, outfit_id:19)
Like.create(user_id:14, outfit_id:19)

Like.create(user_id:15, outfit_id:20)
Like.create(user_id:1, outfit_id:20)
Like.create(user_id:2, outfit_id:20)
Like.create(user_id:3, outfit_id:20)
Like.create(user_id:4, outfit_id:20)
Like.create(user_id:5, outfit_id:20)
Like.create(user_id:6, outfit_id:20)
Like.create(user_id:7, outfit_id:20)

Like.create(user_id:8, outfit_id:21)
Like.create(user_id:9, outfit_id:21)
Like.create(user_id:10, outfit_id:21)
Like.create(user_id:11, outfit_id:21)
Like.create(user_id:12, outfit_id:21)
Like.create(user_id:13, outfit_id:21)
Like.create(user_id:15, outfit_id:21)
Like.create(user_id:7, outfit_id:21)
Like.create(user_id:6, outfit_id:21)
Like.create(user_id:5, outfit_id:21)
Like.create(user_id:4, outfit_id:21)

Like.create(user_id:3, outfit_id:22)
Like.create(user_id:2, outfit_id:22)
Like.create(user_id:1, outfit_id:22)
Like.create(user_id:15, outfit_id:22)
Like.create(user_id:14, outfit_id:22)
Like.create(user_id:13, outfit_id:22)
Like.create(user_id:12, outfit_id:22)
Like.create(user_id:11, outfit_id:22)

Like.create(user_id:12, outfit_id:23)
Like.create(user_id:13, outfit_id:23)
Like.create(user_id:14, outfit_id:23)
Like.create(user_id:15, outfit_id:23)
Like.create(user_id:11, outfit_id:23)
Like.create(user_id:10, outfit_id:23)
Like.create(user_id:9, outfit_id:23)
Like.create(user_id:8, outfit_id:23)

Like.create(user_id:7, outfit_id:24)
Like.create(user_id:6, outfit_id:24)
Like.create(user_id:5, outfit_id:24)
Like.create(user_id:3, outfit_id:24)
Like.create(user_id:2, outfit_id:24)
Like.create(user_id:1, outfit_id:24)
Like.create(user_id:8, outfit_id:24)
Like.create(user_id:9, outfit_id:24)
Like.create(user_id:10, outfit_id:24)
Like.create(user_id:11, outfit_id:24)

Like.create(user_id:12, outfit_id:25)
Like.create(user_id:13, outfit_id:25)
Like.create(user_id:14, outfit_id:25)
Like.create(user_id:15, outfit_id:25)
Like.create(user_id:11, outfit_id:25)
Like.create(user_id:10, outfit_id:25)
Like.create(user_id:9, outfit_id:25)
Like.create(user_id:8, outfit_id:25)
Like.create(user_id:7, outfit_id:25)
Like.create(user_id:6, outfit_id:25)
Like.create(user_id:5, outfit_id:25)

Like.create(user_id:4, outfit_id:26)
Like.create(user_id:3, outfit_id:26)
Like.create(user_id:2, outfit_id:26)
Like.create(user_id:1, outfit_id:26)
Like.create(user_id:5, outfit_id:26)
Like.create(user_id:6, outfit_id:26)
Like.create(user_id:7, outfit_id:26)
Like.create(user_id:8, outfit_id:26)
Like.create(user_id:9, outfit_id:26)

Like.create(user_id:10, outfit_id:27)
Like.create(user_id:11, outfit_id:27)
Like.create(user_id:12, outfit_id:27)
Like.create(user_id:13, outfit_id:27)
Like.create(user_id:14, outfit_id:27)
Like.create(user_id:15, outfit_id:27)
Like.create(user_id:9, outfit_id:27)
Like.create(user_id:7, outfit_id:27)

Like.create(user_id:6, outfit_id:28)
Like.create(user_id:5, outfit_id:28)
Like.create(user_id:4, outfit_id:28)
Like.create(user_id:3, outfit_id:28)
Like.create(user_id:2, outfit_id:28)
Like.create(user_id:1, outfit_id:28)

Like.create(user_id:15, outfit_id:29)
Like.create(user_id:13, outfit_id:29)
Like.create(user_id:12, outfit_id:29)
Like.create(user_id:11, outfit_id:29)
Like.create(user_id:10, outfit_id:29)
Like.create(user_id:9, outfit_id:29)

Like.create(user_id:8, outfit_id:30)
Like.create(user_id:7, outfit_id:30)
Like.create(user_id:6, outfit_id:30)
Like.create(user_id:5, outfit_id:30)
Like.create(user_id:3, outfit_id:30)
Like.create(user_id:2, outfit_id:30)
Like.create(user_id:1, outfit_id:30)
Like.create(user_id:15, outfit_id:30)

Like.create(user_id:14, outfit_id:31)
Like.create(user_id:13, outfit_id:31)
Like.create(user_id:12, outfit_id:31)
Like.create(user_id:11, outfit_id:31)
Like.create(user_id:10, outfit_id:31)
Like.create(user_id:9, outfit_id:31)
Like.create(user_id:7, outfit_id:31)
Like.create(user_id:6, outfit_id:31)
Like.create(user_id:5, outfit_id:31)
Like.create(user_id:4, outfit_id:31)
Like.create(user_id:3, outfit_id:31)

Like.create(user_id:2, outfit_id:32)
Like.create(user_id:1, outfit_id:32)
Like.create(user_id:15, outfit_id:32)
Like.create(user_id:14, outfit_id:32)
Like.create(user_id:13, outfit_id:32)
Like.create(user_id:12, outfit_id:32)
Like.create(user_id:11, outfit_id:32)

Like.create(user_id:10, outfit_id:33)
Like.create(user_id:9, outfit_id:33)
Like.create(user_id:8, outfit_id:33)
Like.create(user_id:7, outfit_id:33)
Like.create(user_id:6, outfit_id:33)
Like.create(user_id:5, outfit_id:33)
Like.create(user_id:4, outfit_id:33)
Like.create(user_id:3, outfit_id:33)

Like.create(user_id:1, outfit_id:34)
Like.create(user_id:15, outfit_id:34)
Like.create(user_id:14, outfit_id:34)
Like.create(user_id:13, outfit_id:34)
Like.create(user_id:12, outfit_id:34)
Like.create(user_id:11, outfit_id:34)
Like.create(user_id:10, outfit_id:34)
Like.create(user_id:9, outfit_id:34)
Like.create(user_id:8, outfit_id:34)

Like.create(user_id:7, outfit_id:35)
Like.create(user_id:6, outfit_id:35)
Like.create(user_id:5, outfit_id:35)
Like.create(user_id:4, outfit_id:35)
Like.create(user_id:3, outfit_id:35)
Like.create(user_id:2, outfit_id:35)
Like.create(user_id:1, outfit_id:35)

Like.create(user_id:15, outfit_id:36)
Like.create(user_id:14, outfit_id:36)
Like.create(user_id:13, outfit_id:36)
Like.create(user_id:12, outfit_id:36)
Like.create(user_id:11, outfit_id:36)
Like.create(user_id:10, outfit_id:36)
Like.create(user_id:9, outfit_id:36)
Like.create(user_id:8, outfit_id:36)
Like.create(user_id:7, outfit_id:36)

Like.create(user_id:6, outfit_id:37)
Like.create(user_id:5, outfit_id:37)
Like.create(user_id:4, outfit_id:37)
Like.create(user_id:3, outfit_id:37)
Like.create(user_id:2, outfit_id:37)
Like.create(user_id:1, outfit_id:37)
Like.create(user_id:7, outfit_id:37)

Like.create(user_id:8, outfit_id:38)
Like.create(user_id:9, outfit_id:38)
Like.create(user_id:10, outfit_id:38)
Like.create(user_id:11, outfit_id:38)
Like.create(user_id:12, outfit_id:38)
Like.create(user_id:13, outfit_id:38)
Like.create(user_id:15, outfit_id:38)

Like.create(user_id:7, outfit_id:39)
Like.create(user_id:6, outfit_id:39)
Like.create(user_id:5, outfit_id:39)
Like.create(user_id:4, outfit_id:39)
Like.create(user_id:3, outfit_id:39)
Like.create(user_id:2, outfit_id:39)

Like.create(user_id:1, outfit_id:40)
Like.create(user_id:14, outfit_id:40)
Like.create(user_id:13, outfit_id:40)
Like.create(user_id:12, outfit_id:40)
Like.create(user_id:11, outfit_id:40)
Like.create(user_id:10, outfit_id:40)
Like.create(user_id:9, outfit_id:40)
Like.create(user_id:8, outfit_id:40)
Like.create(user_id:7, outfit_id:40)

Like.create(user_id:9, outfit_id:41)
Like.create(user_id:10, outfit_id:41)
Like.create(user_id:11, outfit_id:41)
Like.create(user_id:12, outfit_id:41)
Like.create(user_id:13, outfit_id:41)
Like.create(user_id:14, outfit_id:41)
Like.create(user_id:15, outfit_id:41)

Like.create(user_id:14, outfit_id:42)
Like.create(user_id:13, outfit_id:42)
Like.create(user_id:12, outfit_id:42)
Like.create(user_id:11, outfit_id:42)
Like.create(user_id:10, outfit_id:42)
Like.create(user_id:9, outfit_id:42)
Like.create(user_id:8, outfit_id:42)
Like.create(user_id:7, outfit_id:42)
Like.create(user_id:6, outfit_id:42)
Like.create(user_id:5, outfit_id:42)

##Like.create(user_id:, outfit_id:)
...
Comment.create(user_id:9, outfit_id:2, text:'OHKAYYYYYY <3', created_at: "2020-07-08 20:04:35")
Comment.create(user_id:8, outfit_id:2, text:'ayyyyyy✨', created_at: "2020-07-09 20:04:35")
...
Comment.create(user_id:11, outfit_id:4, text:'queen 👑', created_at: "2020-07-08 20:04:35")
Comment.create(user_id:12, outfit_id:4, text:'yes girl!', created_at: "2020-07-09 20:04:35")
Comment.create(user_id:13, outfit_id:4, text:'would wear this! <3', created_at: "2020-07-09 20:04:35")
Comment.create(user_id:10, outfit_id:4, text:'OOOOO I see you 👀', created_at: "2020-07-10 20:04:35")
...
Comment.create(user_id:12, outfit_id:6, text:'yes girl!', created_at: "2020-07-08 20:04:35")
Comment.create(user_id:13, outfit_id:6, text:'would wear this! <3', created_at: "2020-07-09 20:04:35")
Comment.create(user_id:14, outfit_id:6, text:'😍😍😍😍😍', created_at: "2020-07-09 20:04:35")
...
Comment.create(user_id:11, outfit_id:9, text:'queen 👑', created_at: "2020-07-08 20:04:35")
Comment.create(user_id:12, outfit_id:9, text:'yes girl!', created_at: "2020-07-09 20:04:35")
Comment.create(user_id:13, outfit_id:9, text:'would wear this! <3', created_at: "2020-07-09 20:04:35")
Comment.create(user_id:14, outfit_id:9, text:'😍😍😍😍😍', created_at: "2020-07-10 20:04:35")
...
Comment.create(user_id:10, outfit_id:11, text:'OOOOO I see you 👀', created_at: "2020-07-08 20:04:35")
Comment.create(user_id:11, outfit_id:11, text:'queen 👑', created_at: "2020-07-09 20:04:35")
Comment.create(user_id:12, outfit_id:11, text:'yes girl!', created_at: "2020-07-09 20:04:35")
Comment.create(user_id:13, outfit_id:11, text:'would wear this! <3', created_at: "2020-07-10 20:04:35")
Comment.create(user_id:14, outfit_id:11, text:'😍😍😍😍😍', created_at: "2020-07-10 20:04:35")
...
Comment.create(user_id:11, outfit_id:13, text:'queen 👑', created_at: "2020-07-09 20:04:35")
Comment.create(user_id:10, outfit_id:13, text:'OOOOO I see you 👀', created_at: "2020-07-09 20:04:35")
Comment.create(user_id:8, outfit_id:13, text:'ayyyyyy✨', created_at: "2020-07-10 20:04:35")
...
Comment.create(user_id:8, outfit_id:16, text:'ayyyyyy✨', created_at: "2020-07-11 20:04:35")

Comment.create(user_id:14, outfit_id:17, text:'😍😍😍😍😍', created_at: "2020-07-08 20:04:35")
Comment.create(user_id:11, outfit_id:17, text:'queen 👑', created_at: "2020-07-09 20:04:35")
Comment.create(user_id:10, outfit_id:17, text:'OOOOO I see you 👀', created_at: "2020-07-09 20:04:35")
Comment.create(user_id:9, outfit_id:17, text:'OHKAYYYYYY <3', created_at: "2020-07-10 20:04:35")
Comment.create(user_id:8, outfit_id:17, text:'ayyyyyy✨', created_at: "2020-07-10 20:04:35")
...
Comment.create(user_id:9, outfit_id:19, text:'OHKAYYYYYY <3', created_at: "2020-07-08 20:04:35")
Comment.create(user_id:13, outfit_id:19, text:'would wear this! <3', created_at: "2020-07-09 20:04:35")
...
Comment.create(user_id:13, outfit_id:21, text:'would wear this! <3', created_at: "2020-07-09 20:04:35")
Comment.create(user_id:15, outfit_id:21, text:'liked and commented <3', created_at: "2020-07-09 20:04:35")
...
Comment.create(user_id:14, outfit_id:23, text:'😍😍😍😍😍', created_at: "2020-07-09 20:04:35")

Comment.create(user_id:7, outfit_id:24, text:'that drip 💦', created_at: "2020-07-08 20:04:35")
Comment.create(user_id:6, outfit_id:24, text:'🔥🔥🔥', created_at: "2020-07-09 20:04:35")
...
Comment.create(user_id:13, outfit_id:25, text:'would wear this! <3', created_at: "2020-07-09 20:04:35")
Comment.create(user_id:14, outfit_id:25, text:'😍😍😍😍😍', created_at: "2020-07-09 20:04:35")
Comment.create(user_id:8, outfit_id:25, text:'ayyyyyy✨', created_at: "2020-07-10 20:04:35")
Comment.create(user_id:7, outfit_id:25, text:'that drip 💦', created_at: "2020-07-10 20:04:35")
...
Comment.create(user_id:10, outfit_id:27, text:'OOOOO I see you 👀', created_at: "2020-07-08 20:04:35")
Comment.create(user_id:11, outfit_id:27, text:'queen 👑', created_at: "2020-07-09 20:04:35")
...
Comment.create(user_id:15, outfit_id:29, text:'liked and commented <3', created_at: "2020-07-08 20:04:35")
Comment.create(user_id:13, outfit_id:29, text:'would wear this! <3', created_at: "2020-07-09 20:04:35")
Comment.create(user_id:9, outfit_id:29, text:'OHKAYYYYYY <3', created_at: "2020-07-09 20:04:35")
...
Comment.create(user_id:10, outfit_id:31, text:'OOOOO I see you 👀', created_at: "2020-07-09 20:04:35")
Comment.create(user_id:9, outfit_id:31, text:'OHKAYYYYYY <3', created_at: "2020-07-09 20:04:35")
...
Comment.create(user_id:9, outfit_id:34, text:'OHKAYYYYYY <3', created_at: "2020-07-10 20:04:35")
...
Comment.create(user_id:13, outfit_id:36, text:'would wear this! <3', created_at: "2020-07-09 20:04:35")
Comment.create(user_id:12, outfit_id:36, text:'yes girl!', created_at: "2020-07-10 20:04:35")
Comment.create(user_id:11, outfit_id:36, text:'queen 👑', created_at: "2020-07-10 20:04:35")
Comment.create(user_id:10, outfit_id:36, text:'OOOOO I see you 👀', created_at: "2020-07-10 20:04:35")
...
Comment.create(user_id:8, outfit_id:38, text:'ayyyyyy✨', created_at: "2020-07-08 20:04:35")
Comment.create(user_id:9, outfit_id:38, text:'OHKAYYYYYY <3', created_at: "2020-07-09 20:04:35")
Comment.create(user_id:13, outfit_id:38, text:'would wear this! <3', created_at: "2020-07-09 20:04:35")
Comment.create(user_id:15, outfit_id:38, text:'liked and commented <3', created_at: "2020-07-10 20:04:35")
...
Comment.create(user_id:7, outfit_id:40, text:'that drip 💦', created_at: "2020-07-10 20:04:35")

Comment.create(user_id:9, outfit_id:41, text:'OHKAYYYYYY <3', created_at: "2020-07-08 20:04:35")
Comment.create(user_id:10, outfit_id:41, text:'OOOOO I see you 👀', created_at: "2020-07-09 20:04:35")
Comment.create(user_id:15, outfit_id:41, text:'liked and commented <3', created_at: "2020-07-09 20:04:35")

Comment.create(user_id:14, outfit_id:42, text:'😍😍😍😍😍', created_at: "2020-07-08 20:04:35")
Comment.create(user_id:13, outfit_id:42, text:'would wear this! <3', created_at: "2020-07-09 20:04:35")
Comment.create(user_id:12, outfit_id:42, text:'yes girl!', created_at: "2020-07-09 20:04:35")
Comment.create(user_id:11, outfit_id:42, text:'queen 👑', created_at: "2020-07-10 20:04:35")
Comment.create(user_id:7, outfit_id:42, text:'that drip 💦', created_at: "2020-07-10 20:04:35")
Comment.create(user_id:6, outfit_id:42, text:'🔥🔥🔥', created_at: "2020-07-10 20:04:35")
Comment.create(user_id:5, outfit_id:42, text:'yasssss!!', created_at: "2020-07-11 20:04:35")

p "comments seeded"

p "done freaking seeding!!!!!"
